# Chapter 5 : The “Factions” Arena of Play Dealing with Interpersonal, Group and Societal Dynamics
...
Unlike martial skills, which focus on the tactical realm and physical movement, faction skills rely on negotiation, intimidation, investigation and persuasion, but none of that matters if you don’t know who you’re dealing with, or they don’t know to be afraid of you. Unlike encounter skills which also use the strategic hour-long intervals, faction attacks usually don’t lead to fighting. Faction attacks must be done in broad daylight to prevent retaliation, with overwhelming numbers and often the force of the law behind them. An encounter-based character may seek sabotage by sneaking into an opposing party’s camp and subtly breaking things before skulking back into the night. A faction attack would not be so subtle and could include a police raid for contraband. At that moment, when the Sheriff is serving the warrant, the opposing party can make a faction save to convince him of their innocence, or at least not to break anything, or even to go after the original perpetrator, but if they have no one convincing, no one who knows local customs or has friends in high places, they have no choice but to succumb to the faction attack.

### Faction Checks

Faction checks operate just like checks from the other 3 arenas, and like checks from those other arenas, they have some idiosyncrasies. Like the other arenas, you need to be able to target a creature to make a faction check against them. In the case of faction checks you must also be able to communicate with them either temporarily or permanently. You roll 2d12, and subtract your opponent’s passive or active defense, applying buffs or debuffs as necessary. The result can be applied as damage incurring a social condition, initiative points when establishing an encounter, intel points, success or failure, or any other result relevant to the particular challenge you are facing.
...
Anything clearly defined as part of your relations status with an individual or group, or anything that is not defined but your table agrees on, takes only an action, not a check. For example, asking a hospitable person to allow you to hide in their car does not require a check. If there are multiple competing relations involved, you will make a Position Change check as seen below.

### Out of Line

Acting in a way that is out of line, ie taking actions beneath your expected relations status, usually takes the form of a save against a social condition. For example, if you are being pushed around by a belligerent so you shoot at them with a gun, you have taken a hostile action against them. Failure to hit them would also be a failed faction save and would result in a social condition such as confounded or suspected. Our emotional reactions to these extreme social stresses can sometimes be unpredictable or unexpected. You may act inhospitably to a stranger seeking shelter from a storm, only to develop anxiety and come to fear them, even though it is you who has wronged them by turning them away.

## Factions Checks, Being Identical to all other checks but within the Factions Arena.

### Social Change: Inciting Acts

Inciting someone to do something one step above or below your current relations status requires a social change check. The time it takes to perform the check is one step above the time it takes to enact the check. This means it takes one minute to convince someone to take one action, ten minutes to convince them to act for one minute, etc. The result of 1-4 is the number of such actions you can convince them to take. A breakthrough of 5 or above will convince the target to act concurrently for the full time it took you to convince them. Normally, you must convince someone to do something, describe what you want, and then they do it. With a breakthrough, you can convince them to take the action while you are in the act of explaining and convincing them.

Keep in mind that some actions are multidimensional. While a guard might be hospitable toward you, and you could incite them to release you as a benevolent act toward you, this betrayal would be a belligerent act against their faction, far below their expected benevolent relation. You would not be able to incite them to do this.

### Position Change: Complex Relations

Sometimes people have multiple competing relationships all at once, and it becomes unclear what they should do. In these circumstances, you should use a social standing position change challenge. If you like, you can put down a chart representing the relations on the table and place figures to represent those involved and their current status. Mark out where they need to be for you to win, then attempt to move there. A result of 1-4 allows you to move by one step, whereas a breakthrough allows you to resolve the challenge in your favour. Once the challenge is complete, all relations return to their pre-challenge status. Each round of such a challenge usually takes the same amount of time as the action in question, so negotiating with someone to let you use a faction asset that you don't have access to can take hours.

For example, you ask a hospitable stranger to hide in their car. They allow you because it is the hospitable thing to do. Next, a faction member that opposes you asks the stranger if you are in the car. The problem now is that it would be hospitable to tell them, but it would be indifferent to reveal you. Within the short position change challenge you are trying to either get yourself up to benevolent, or the opponent down to indifferent. In either case the stranger will work on your behalf. The same is true of your opponent. Each of you takes a turn trying to achieve the positioning you want. Once you have the position, you must then take a turn to get the stranger to take the action of lying or revealing you respectively to finish the encounter.

### Gain Intelligence: Gossip and Research

You can engage with benevolent or dedicated characters to gain intelligence about things they know. Because intelligence is valuable, and exchanging it can be risky, hospitable characters will happily engage in intelligence gathering on an exchange basis (you pay for a service they explicitly offer, usually 1GP per intel point). You can make an intelligence check with such a character to gain intel by interviewing, asking around and researching without exposing yourself to the target of your investigations. Like Magic and Recon intelligence checks, if you are proficient you can also actively defend against faction intelligence gathering targeting you by taking an hour and making a check to do so. On a *breakthrough*, you can gain intelligence from a hospitable target for free, or learn a *secret*.

### Bestow Conditions: Social Attacks

You can spend an hour shunning, bullying or slandering someone to their face as a belligerent act. While no one would blame them for trying to knock those vile words right out of your mouth, sometimes the circumstances are just right and they can't do so. At the end of the hour, you roll an attack and serve the damage to try to impose social conditions on them. Many factions skills allow you to undertake more subtle or effective methods of social attacks.

### Gain Initiative: Hosting Negotiations

You can ask people to point you in the direction of a target, or even to intentionally set up a meeting with them. If you are exceptionally well positioned socially, you can even contrive a social ambush where you are well prepared, well dressed and surrounded by friends, and they are cold and alone. Use an hour to make an initiative check if your target is known to your circle of benevolent or dedicated allies and they are operating in public.
...
Factions only operate in certain regions, and usually only certain locales within those regions. For example a gang might only operate in a certain country, and only in gang-held enclaves within that country. Outside of these areas, they exist, however their powers are much more limited. You can usually only access assets in regions where the faction operates, and can only rely on their complete control in their specialized locales. For example, in a locale dominated by faction, a character can get in touch with a representative of the faction freely and can assume that at least a few identifiable NPCs in the locale will be faction members. You can also assume that the expectations and social norms will be set by the faction, and that relations between individuals will be based on the faction’s relations.
...
Faction relations are the norm between individuals of different factions. You are always expected to behave benevolently toward your own faction and its members, but factions may also set a default relation you have with members of specific other factions, for example considering another faction to be an ally (benevolent) or an enemy (belligerent). You can be a member of more than one faction, but only if all your factions treat eachother benevolently or with dedication because maintaining inappropriately high or low relations within your various factions would be grounds for expulsion.
...
## The Benefits and Requirements of Membership to A Faction

Any character can be loosely affiliated with other members of a faction through narrative or role-play, but they are not considered to be an official member unless they have used one levelling point to adopt official membership into that faction, including starting off at level one as a member of the faction.
...
Through its initial expectations or through shared knowledge and training, membership to a faction also conveys a number of proficiencies.
...
If a player does not want their character to be a member of a faction any more, they can pursue **expulsion** from a faction. Undertaking a narrative arc of betrayal, self-discovery, or some other journey, they will disentangle themselves from the faction and reallocate their faction skill to a different faction. Because the assets, social arts, and interpersonal interactions of a faction are particular to its members, they will lose these parts of their skill, but may retain some language abilities and relations to individual characters as part of their background. 

## Faction Equipment, Which is to say Currency and Market Tables, not Assets

### Currencies

GP is the basic mechanical currency standard for running the game. In your setting, you can decide on any number of specific currency systems and then relate them to a GP exchange for simplicity’s sake, or simply use GP. You may also decide that one person is in charge of monetary systems aside from the main GM.

While playing, you can track your character’s GP, representing the wealth they have on hand, but it is assumed that they are persisting in the world, buying selling and trading as they go about their day and using common currencies. For an inventory call in the case of GP, you can consult the local market table and see the sorts of things your character might use as currency, and decide which of those things they are carrying and how.

### Market Tables

Market tables are constructed in Round Table because the system simulates a guilded and non-globalized series of economies. You may choose to use a single market table for your entire setting for simplicity’s sake, and that’s fine. You may also find that someone at the table is interested in game economics, and they may take care of market tables instead of the main GM, or that another player who is working on a specific faction may want to create a market table for that faction. In any case, you should have a market table for every faction that might deal in goods or services. Your character can take an hour to go to the market and exchange any goods for any other goods, services or currency on the tables. If you have or want an item that is not on the table, you will likely have to make a faction check to buy or sell it, or your GM may indicate that it would be impossible to do so.
